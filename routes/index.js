...
const HttpLogInfoController = require("../controllers/HttpLogInfo");
...
// http 请求列表
router.get("/getHttpLogInfoList", HttpLogInfoController.getHttpLogInfoList);
...
// 获取加载信息列表
router.get("/loadPage", LoadPageController.getLoadPageInfoList);
// 获取加载信息详情
...
router.get(
  "/javascriptErrorInfo",
  JavascriptErrorInfo.getJavascriptErrorInfoList
);
// 获取JS错误详情
...
// 查询一个月内每天的错误总量
router.get(
  "/getJavascriptErrorInfoListByDay",
  JavascriptErrorInfo.getJavascriptErrorInfoListByDay
);
// 查询一个天内每小时的错误量
router.get(
  "/getJavascriptErrorInfoListByHour",
  JavascriptErrorInfo.getJavascriptErrorInfoListByHour
);
// 根据JS错误数量进行分类排序
router.post(
  "/getJavascriptErrorSort",
  JavascriptErrorInfo.getJavascriptErrorSort
);
// 获取最近六小时内，js错误发生数量
router.get(
  "/getJavascriptErrorCountByHour",
  JavascriptErrorInfo.getJavascriptErrorCountByHour
);
// 获取各种平台js报错熟练
router.get(
  "/getJavascriptErrorCountByOs",
  JavascriptErrorInfo.getJavascriptErrorCountByOs
);
// 根据ErrorMsg获取js错误列表
router.post(
  "/getJavascriptErrorListByMsg",
  JavascriptErrorInfo.getJavascriptErrorListByMsg
);
// 根据ErrorMsg获取js错误列表
router.post(
  "/getJavascriptErrorAboutInfo",
  JavascriptErrorInfo.getJavascriptErrorAboutInfo
);
// 根据页面获取js错误列表
router.get(
  "/getJavascriptErrorListByPage",
  JavascriptErrorInfo.getJavascriptErrorListByPage
);
// 定位JS错误代码
router.post(
  "/getJavascriptErrorStackCode",
  JavascriptErrorInfo.getJavascriptErrorStackCode
);
...
router.get(
  ...
  ScreenShotInfo.getScreenShotInfoListByPage
);
// 获取截屏详情
...
// 获取应用忽略js错误信息列表
router.get(
  "/ignoreErrorByApplication",
  IgnoreErrorController.ignoreErrorByApplication
);
// 获取忽略js错误信息详情
